...
Depot GitHub: https://github.com/Alainjoe/pipeline-inventaire (public, branche main)

| # | Preuve | Etat |
|---|--------|------|
| 1 | Depot GitHub avec structure initiale | OK (pousse, public) |
| 2 | `psql`: `\dt` et `SELECT COUNT(*) FROM articles;` = 5 | OK (valide local) |
| 3 | Push du service postgres | OK (dans le repo) |
...
| 7 | Historique GitHub avec commits des deux etudiants | Partiel (commit Etudiant 1 fait, Etudiant 2 a faire) |
